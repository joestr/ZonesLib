...
public enum ZoneType {
	...
	/**
	 *  A cylinder is defined as any ruled surface spanned by a one-parameter family of parallel lines
	 */
	CYLINDER(2, "Cylinder", CylinderZone.class, 2, 2),
	/**
	 * A sphere is a perfectly round geometrical and circular object in three-dimensional space that resembles the shape of a completely round ball.
	 */
	...
	private ZoneType(int typeId, String typeName, Class<? extends Zone> typeClass, int minimumPoins, int maximumPoints) {
		this.typeId = typeId;
