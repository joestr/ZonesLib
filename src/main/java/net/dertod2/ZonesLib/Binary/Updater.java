...
public class Updater {
     ...
     */
    public static final String mavenUri = "https://nexus.joestr.xyz/service/rest/repository/browse/maven-snapshots/net/dertod2/ZonesLib/";
    ...
    public static final boolean downloadUpdate = ZonesLib.getInstance().getConfig().getBoolean("download-updates",
            false);
