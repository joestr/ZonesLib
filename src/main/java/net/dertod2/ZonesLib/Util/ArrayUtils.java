...
/**
 * Shares different Methods to convert Primitive Arrays to Object Arrays and<br />
...
public class ArrayUtils {
	...
	public static Byte[] toObject(byte[] primitiveArray) {
		...
		for (int i = 0; i < primitiveArray.length; i++) objectArray[i] = primitiveArray[i];
	...
	public static byte[] toPrimitive(Byte[] objectArray) {
		...
		for (int i = 0; i < objectArray.length; i++) primitiveArray[i] = objectArray[i];
